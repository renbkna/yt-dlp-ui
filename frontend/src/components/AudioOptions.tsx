...
export const AudioOptions = ({ downloadOptions, updateDownloadOption }: AudioOptionsProps) => (
  <div className="ml-6 space-y-4">
    <div className="space-y-2">
      <Label>Audio Format</Label>
      <Select 
        value={downloadOptions.audioFormat}
        onValueChange={v => updateDownloadOption('audioFormat', v)}
      >
        <SelectTrigger>
          <SelectValue />
        </SelectTrigger>
    ...
    <div className="space-y-2">
      ...
      <Select 
        ...
        onValueChange={v => updateDownloadOption('audioQuality', v)}
      >
        <SelectTrigger>
          <SelectValue />
        </SelectTrigger>
