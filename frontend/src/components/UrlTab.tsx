    ...
    return (
      ...
      >
        <div className="space-y-5">
          <div className="dark:border-b border-primary/10 pb-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                rounded-full px-3 ${
                  pasteAnimation
                    ? 'dark:border-success border-success dark:text-success text-success'
                    : ''
                }`}
              >
            ...
            <p className="text-sm dark:text-primary-foreground/70 text-secondary-foreground/70 mt-1">
              Enter a URL from YouTube, TikTok, Twitter, or any other supported
              service
            </p>
          </div>
            ...
            <Input
              ...
              className={`h-12 pl-5 pr-12 text-base dark:border-primary/30 border-secondary/30
                ...
                rounded-xl shadow-sm ${
                  urlFocused
                    ? 'dark:ring-2 dark:ring-primary/20 ring-2 ring-secondary/20'
                    : ''
                }`}
            />
          ...
          <div
            className="flex items-center space-x-2 px-5 py-4 dark:bg-primary/5 bg-secondary/10
          ...
          >
            ...
            {isPlaylist && (
              <span
                className="ml-auto text-xs dark:bg-primary/20 bg-secondary/20 px-2.5 py-1 rounded-full
        ...
        <div className="pt-1">
          ...
          <div className="mt-5 flex items-center justify-center">
            <p className="text-xs dark:text-primary-foreground/60 text-secondary-foreground/60 text-center">
              Supports YouTube, TikTok, Twitter, Instagram, Soundcloud, and many
              more services
            </p>
          </div>
        </div>
